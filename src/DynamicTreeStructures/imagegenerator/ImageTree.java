...
public class ImageTree<T, K extends Comparable<K>> implements TreeImage {
	 ...
	 * máximo ancho que ocupa la representación gráfica del árbol de la fila con más
	 * datos. Para cada fila del árbol primero se saca las dimensiones del nodo, con
	 * las dimensiones se calcula la posición. Siempre se tiene en cuenta los
